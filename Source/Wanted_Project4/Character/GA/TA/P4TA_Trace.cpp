...
void AP4TA_Trace::StartTargeting(UGameplayAbility* Ability)
{
...
void AP4TA_Trace::ConfirmTargetingAndContinue()
{
	if (SourceActor)
	{
...
FGameplayAbilityTargetDataHandle AP4TA_Trace::MakeTargetData() const
{
